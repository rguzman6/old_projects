...
void findPath(int** array, char** charArray, int startx, int starty, int width, int height)
{
  ...
  while(!reachedGoal)
	...
	{
	  //cout << pathx << ", " << pathy << ", " << array[pathy+1][pathx+1] << "down to right" << endl;

	  if(array[pathy+1][pathx+1] == 1)
	    {
	      reachedGoal = true; 
	    }
	  //checks to make sure that spot is not already visited
	  //if not visited and smaller than the current value, goes in that direction
	  else if(charArray[pathy+1][pathx+1] == ' ')
	    {
	...
	{
	  //cout << pathx << ", " << pathy << ", " << array[pathy+1][pathx+1] << "down " << endl;
	  ...
	  //checks to make sure that spot is not already visited
	  //if not visited and smaller than the current value, goes in that direction
	  else if(charArray[pathy+1][pathx] == ' ')
	    {
	...
	{
	  //cout << pathx << ", " << pathy << ", " << array[pathy+1][pathx+1] << "right" << endl;
	  ...
	  //checks to make sure that spot is not already visited
	  //if not visited and smaller than the current value, goes in that direction
	  else if(charArray[pathy][pathx+1] == ' ')
	    {
	...
	{
	  //cout << pathx << ", " << pathy << ", " << array[pathy+1][pathx+1] << "up right" << endl;
	...
	{
	  //	  cout << pathx << ", " << pathy << ", " << array[pathy+1][pathx+1] << "down left" << endl;
	...
	{
	  //	  cout << pathx << ", " << pathy << ", " << array[pathy+1][pathx+1] << "left" << endl;
	...
	{
	  //	  cout << pathx << ", " << pathy << ", " << array[pathy+1][pathx+1] << "up" << endl;
	...
	{
	  // cout << pathx << ", " << pathy << ", " << array[pathy+1][pathx+1] << "up left" << endl;
	  ...
	  //if not visited and smaller than the current value, goes in that direction
	  else if(charArray[pathy-1][pathx-1] == ' ')
	    {
	      ...
	      pathx = pathx-1; 
	      pathy = pathy-1; 
	      cout << pathx << ", " << width << ", " << pathy << ", " << height << "d " << endl;
	      //	      PrintCharEnvironment(charArray, width, height);
	    }
	}
...
int main(int argc, char** argv)
{
  ...
  bool validGoal = false; //makes sure that the goal value is valid
  bool validStart = false; //makes sure the starting point is valid
  bool validGrid = false; //makes sure the grid is not less than 10
  ...
  if(argc == 3 && strcmp(argv[2], "-f") == 0)
    ...
    {
      //ask user about the grid they would like to generate
      cout << "Please tell me about the grid you want to generate.\n";
      //makes sure grid is at least 10x10
      while(!validGrid)
	{
      ...
      //create integer array based on user input and initialize to 0
      intGrid = new int*[height];
      for(int row = 0; row < height; row++)
	{
	  intGrid[row] = new int[width];
      ...
      if(impassible > 40)
	{
      ...
      //calculates total number of obstacles based on percentage given
  ...
  //asks for an x and y coordinate & makes sure is valid
  while(!validStart)
    {
